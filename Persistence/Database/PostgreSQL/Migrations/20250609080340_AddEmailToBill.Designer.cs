...
namespace Persistence.Database.PostgreSQL.Migrations
{
    ...
    [Migration("20250609080340_AddEmailToBill")]
    partial class AddEmailToBill
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Vouchers.Voucher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            VoucherId = new Guid("019753b7-6e9e-ebdb-7c19-1d317b5cc05f"),
                            Description = "Voucher dành riêng cho khách hàng mới đăng ký tài khoản",
                            ExpiredDate = new DateOnly(2026, 6, 9),
