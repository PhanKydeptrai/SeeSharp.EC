...
internal sealed class MakePaymentForGuestCommandValidator : AbstractValidator<MakePaymentForGuestCommand>
{
    public MakePaymentForGuestCommandValidator()
    {
        RuleFor(x => x.GuestId)
            .NotEmpty()
            .WithErrorCode("GuestId.Required")
