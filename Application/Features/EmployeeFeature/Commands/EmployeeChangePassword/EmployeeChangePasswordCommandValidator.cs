...
internal sealed class EmployeeChangePasswordCommandValidator : AbstractValidator<EmployeeChangePasswordCommand>
{
    public EmployeeChangePasswordCommandValidator()
    {
        RuleFor(x => x.userId)
            .NotEmpty()
