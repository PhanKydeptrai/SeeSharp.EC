...
internal sealed class CategoryRestoredEventHandler : INotificationHandler<CategoryRestoredEvent>
{
    private readonly IConnectionMultiplexer _redis;

    public CategoryRestoredEventHandler(IConnectionMultiplexer redis)
    {
        _redis = redis;
    }

    public async Task Handle(CategoryRestoredEvent notification, CancellationToken cancellationToken)
    {
