    ...
    : IConsumer<CustomerConfirmChangePasswordEvent>
{
    ...
    public async Task Consume(ConsumeContext<CustomerConfirmChangePasswordEvent> context)
    {
        ...
        _logger.LogInformation(
            "Consuming CustomerConfirmChangePasswordEvent for productid: {[id]}",
        ...
        catch (Exception ex)
        {
            ...
            _logger.LogError(
                ex,
                "Failed to consume CustomerConfirmChangePasswordEvent for productid: {[id]}",
                context.Message.UserId);
            //----------------------------------------------------------
        ...
        //Log end------------------------------------------
        _logger.LogInformation(
            "Consumed CustomerConfirmChangePasswordEvent for productid: {[id]}",
            context.Message.UserId);
        //-------------------------------------------------
    }
}
